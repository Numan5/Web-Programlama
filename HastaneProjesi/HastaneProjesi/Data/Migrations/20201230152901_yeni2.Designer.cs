...
namespace HastaneProjesi.Data.Migrations
{
    ...
    [Migration("20201230152901_yeni2")]
    partial class yeni2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HastaneProjesi.Models.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "aa5cad07-afb1-48d5-86be-b09d3634b5a1",
                            ConcurrencyStamp = "9a41410e-c254-478c-83a4-7c90865c375e",
                            Name = "user"
                        },
                        new
                        {
                            Id = "e17291ae-2332-4977-a6bf-e5d6b3bcf356",
                            ConcurrencyStamp = "e5058c06-6e93-4db8-88a6-819d00b3314c",
                            Name = "admin"
                        });
                });

            modelBuilder.Entity("HastaneProjesi.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("HastaneProjesi.Models.UserRol", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("HastaneProjesi.Models.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HastaneProjesi.Models.AppUser", null)
                        .WithMany()
